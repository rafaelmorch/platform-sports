...
export default function GroupTrainingPage() {
  ...
  const createBtnStyle = useMemo(
    () => ({
      ...
      background:
        "linear-gradient(180deg, rgba(239,68,68,0.95), rgba(220,38,38,0.92))",
      color: "#ffffff",
      textDecoration: "none",
      fontWeight: 900,
      height: "fit-content",
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
                {weekly.map((t: any) => (
                  <div key={t.id} style={cardStyle}>
                    <div>
                      <div style={{ fontSize: 16, fontWeight: 900, marginBottom: 6, color: textMain }}>
                        {t.weekLabel}
                      </div>

                      <div style={{ fontSize: 12, fontWeight: 800, color: "rgba(15,23,42,0.78)" }}>
